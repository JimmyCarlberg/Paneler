    ...
    panelTypes.forEach(panel => {
        ...
        b.addEventListener('click', e => {
            ...
            calcResult.addEventListener('click', e => {
                ...
                const totalPanelWidth = (((panelAmount * 2) / panelPerRow) * selectedPanel.width) - 2;
                const centerWidth = (widthOfRoof - totalPanelWidth) / 2;
                const overhang = ((panel.height - panel.cc1) / 2) - 2.5;
                result.innerHTML = `
            ...
            <div class="roofMeasurements"><p><span class="bold">Totallängd:</span> ${Math.round(totalPanelHeight)} cm</p>
...
//     result.innerHTML = `
// <h2>Resultat av beräkning</h2>
// <p>Totalhöjd: ${totalPanelHeight} cm - Antal rader: ${panelPerRow}st</p>
// <p>Totalbredd: ${totalPanelWidth} cm - Antal Paneler: ${panelAmount}st</p>
// <p>Utstick: 26 cm</p>
// <p>Från kant: 43 cm</p>
// `;
// });
...
// //let panelAmount = 6;
// //let panelWidth = 114;
// //let panelHeight = 171.9;
// //let panelPerRow = 2;
// //
// //const totalPanelWidth = (panelAmount / panelPerRow) * panelWidth;
// //totalPanelHeight
// //
// //
// /////
...
// const totalPanelWidth = (panelAmount / panelPerRow) * panelWidth + railOverhang + (gapWidth * panelAmount - 2);

// const totalPanelHeight = panelPerRow * panelHeight + (gapHeight * panelPerRow - 1);

// const panelOverhang = (panelHeight - ccMeasure) / 2;

// const totalOverhang = Math.round(panelOverhang);

// height.innerText = `Height: ${totalPanelHeight} cm - Rows: ${panelPerRow}`;

// width.innerText = `Width: ${totalPanelWidth} cm - Panels: ${panelAmount}`;

// overhang.innerText = `Panel Overhang: ${totalOverhang} cm`;

// const centerWidth = (roofWidth - totalPanelWidth) / 2;

// edge.innerText = `From edges: ${centerWidth} cm`;
